<#
    ВНИМАНИЕ: в текущем виде скрипт не запускается.

    Он обращался к командам собственного HTTP-моста (pointcloud.detect_planes,
    walls.from_planes) и к модулю McpRevit.psm1 — всё это удалено вместе с мостом.
    Файл сохранён ради самой классификации стен; о переносе на команды плагина
    LuDattilo — см. README.md рядом.
